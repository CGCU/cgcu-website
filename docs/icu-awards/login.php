...
include 'not-public/authorised_users.php';
...
if(isset($_POST['sub'])) {
    ...
    if ((pam_auth($username, $password) || sheep($username, $password)) && in_array($username, $authorised_users, true)) {
...
<form name='form-signin' class="form-signin" action='<?php echo $_SERVER['PHP_SELF'];?>' method='post'>
    <h2 class="form-signin-heading">Union Awards Viewer 2019 - Login</h2>
